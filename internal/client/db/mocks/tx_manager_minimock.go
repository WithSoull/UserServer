...
//go:generate minimock -i github.com/WithSoull/AuthService/internal/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock
...
import (
	...
	mm_db "github.com/WithSoull/AuthService/internal/client/db"
