# UserServer
Микросервис управления пользователями для [мессенджера](https://github.com/WithSoull/messenger-overview). Отвечает за создание, обновление, удаление пользователей и валидацию их учетных данных для Auth Service.
